package com.digital4.cpr.store;
...
public class TrainningSessionStore extends GenericDAOStore<TrainningSession> {
	...
	public List<TrainningSession> findSessions(DateRangeType rangeType, DateTime refDate)
		...
		return query(
				new QueryParam("start_time_millis", ">=", startDate.getMillis()),
				new QueryParam("end_time_millis", "<", endDate.getMillis()));
	}
}
